...
class TransactionSettingSeeder extends Seeder
{
    ...
    public function run()
    {
        $transaction_settings = array(
            array('id' => '1','admin_id' => '1','slug' => 'transfer','title' => 'Transfer Money Charges','fixed_charge' => '1.00','percent_charge' => '1.00','min_limit' => '1.00','max_limit' => '1000.00','monthly_limit' => '1000.00','daily_limit' => '1000.00','status' => '1','created_at' => now(),'updated_at' =>now(),'agent_fixed_commissions' => '1.00','agent_percent_commissions' => '1.00','agent_profit' => false),
